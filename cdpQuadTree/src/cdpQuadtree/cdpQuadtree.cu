...
__global__
void build_quadtree_kernel(Quadtree_node *nodes, Points *points, Parameters params, int nodes_offset = 0)
{
...
#pragma unroll
    ...
    if (threadIdx.x == NUM_THREADS_PER_BLOCK-1)
    {
        ...
        // Launch 4 children.
        build_quadtree_kernel<NUM_THREADS_PER_BLOCK><<<4, NUM_THREADS_PER_BLOCK, 4 *NUM_WARPS_PER_BLOCK *sizeof(int)>>>(nodes, points, Parameters(params, true), child_offset);
    }
}
